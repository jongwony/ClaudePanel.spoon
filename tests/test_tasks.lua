...
test("Tasks grouped by _cwd", function()
    ...
    assertEqual(result[1].projectName, "project/a", "First group alphabetically")
    assertEqual(result[2].projectName, "project/b", "Second group alphabetically")
...
test("Tasks without _cwd grouped as Unknown (last)", function()
    ...
    local result = tasks.groupTasksByCwd(input)
    assertEqual(#result, 2, "Should have 2 groups")
    assertEqual(result[1].projectName, "project/a", "Known project first")
